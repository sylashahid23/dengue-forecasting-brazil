...
class DLinearModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # Dengue cases are the first feature
...
print()
print("=" * 60)
print("LSTM + DLinear Stacking Results")
print("=" * 60)
...
output.to_csv(
    OUTPUT_DIR /
    "lstm_dlinear_stacking_predictions.csv",
    index=False
)
...
metrics_output.to_csv(
    OUTPUT_DIR /
    "lstm_dlinear_stacking_metrics.csv",
    index=False
)
...
state_results_df.to_csv(
    OUTPUT_DIR /
    "lstm_dlinear_stacking_state_metrics.csv",
    index=False
)
